...
//     let options = api.getOptions({contentType: null})
//     let url = `https://${config.opalWeb.host}/opalweb/login.aspx`
//
//
//     let getSessionToken = await api.getSessionToken()
//     // console.log('getSessionToken',getSessionToken)
//
//     await api.login()
//         .catch(reject)
//
//     // let pdf = await api.getStudyPDF({studyID: 3331150})
//     let study = await api.getStudyWithReportPDF({accession: '2013080509431089'})
//
//     console.log(study)
//     return
//
...
//             // res.headers.raw()['set-cookie'].forEach(c=>console.log(Object.entries(cookie.parse(c))))
//
//             console.log(getSessionToken, res.url)
...
//     await sleep(2000)
//
//     await api.getDefaultWorkList()
//         .then(async res => {
//             let body = await res.text()
//             console.log(res.headers.get('content-length'))
//             console.log('getDefaultWorkList body:', body)
//         })
//         .catch(reject)
//
//     await sleep(2000)
//
//     await api.getFilteredWorkList('INCOMPLETE')
...
//             // console.log(res.redirected)
//             // console.log(res.headers.get('content-length'))
//             console.log('getFilteredWorkList body:', body)
//         })
//         .catch(reject)
//
//     await sleep(2000)
